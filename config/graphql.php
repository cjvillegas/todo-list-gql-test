...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                \App\GraphQL\Queries\Auth\WhoAmIQuery::class // Structural purposes for the schema. Who am I will always be false here
            ],
        ...
        'user' => [
            'query' => [
                \App\GraphQL\Queries\Auth\WhoAmIQuery::class
            ],

            'mutation' => [
                \App\GraphQL\Mutations\Auth\LogoutMutation::class
            ],
